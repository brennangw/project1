...
def report(webserviceurl):
	...
	print request.form['comment']
        ...
        g.db.execute("INSERT into public.report (reporttype, webserviceurl, reporttextblob, email, reporttime) VALUES ('slow', 'yelp.com', 'Login down. We are on it.', 'sally@gmail.com', '2016-01-30 01:55:52');");
